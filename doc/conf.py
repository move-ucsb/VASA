...
# UGHHHHH FOR SOME reASON THIS ISN'T LOADING FROM VASA ????
VASA.__version__ = "0.0.1"
...
project = "VASA"  # string of your project name, for example, 'giddy'
...
#
# The full version.
version = VASA.__version__  # should replace it with your PACKAGE_NAME
release = VASA.__version__  # should replace it with your PACKAGE_NAME
...
html_theme_options = {
    ...
    'navbar_title': "VASA", # string of your project name, for example, 'giddy'
...
latex_documents = [
    (master_doc, 'VASA.tex', u'VASA Documentation',
...
man_pages = [
    (master_doc, 'VASA', u'VASA Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'VASA', u'VASA Documentation',
     author, 'VASA', 'One line description of project.',
     'Miscellaneous'),
]
